...
export const mealReducer = (state, action) => {
  switch (action.type) {
    ...
    case FETCH_MEALS_BEGIN:
      return { ...state, mealsLoading: true };
    case FETCH_MEALS_ERROR:
      return { ...state, mealsLoading: false, mealsError: true };
    case FETCH_MEALS_SUCCESS:
      return { ...state, mealsLoading: false, meals: action.payload };

    case FETCH_SINGLE_MEAL_BEGIN:
      return { ...state, mealLoading: true };
    case FETCH_SINGLE_MEAL_SUCCESS:
      return { ...state, mealLoading: false, meal: action.payload };
    case FETCH_SINGLE_MEAL_ERROR:
      return { ...state, mealLoading: false, mealError: true };

    case FETCH_CATEGORY_MEALS_BEGIN:
      return { ...state, categoryMealsLoading: true };
